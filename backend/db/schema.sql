...
DROP TABLE IF EXISTS farming_advice CASCADE;
...
-- ---------- SIMULATED: FARMING & LIVESTOCK ADVICE ----------
CREATE TABLE farming_advice (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
  category VARCHAR(50) DEFAULT 'Crops',
...
INSERT INTO farming_advice (category, crop, advice) VALUES
('Crops', 'Maize', 'Plant before the onset of the rainy season and use certified seed for higher yields.'),
('Crops', 'Coffee', 'Prune trees after harvest and mulch to conserve soil moisture for berry swelling.'),
('Crops', 'Tea', 'Pluck regularly every 7-14 days and apply balanced NPK fertilizer after major pruning cycles.'),
('Crops', 'Beans', 'Rotate with cereals to improve soil nitrogen and reduce root rot disease build-up.'),
('Crops', 'Horticulture & Flowers', 'Use drip irrigation to conserve water, apply shade netting, and monitor for thrips and spider mites.'),
('Livestock', 'Dairy Cattle', 'Ensure a consistent supply of clean water, high-protein fodder (Napier grass, lucerne, silage), and mineral licks for maximum daily milk yield.'),
('Livestock', 'Beef Cattle', 'Implement pasture rotation, provide salt blocks, and dip or spray weekly against ticks to protect against East Coast Fever.'),
('Livestock', 'Poultry & Chickens', 'Maintain strict biosecurity, clean drinking water with electrolyte supplements, and execute Newcastle and Gumboro vaccination schedules.'),
('Livestock', 'Goats & Sheep', 'Provide elevated slatted housing to prevent hoof rot, rotate grazing pastures to break worm lifecycles, and deworm quarterly.'),
('Livestock', 'Fish Farming (Aquaculture)', 'Monitor pond pH and dissolved oxygen levels daily, feed floating high-protein pellets, and drain ponds fully between harvests.');
